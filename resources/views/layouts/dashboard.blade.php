...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('keuangan.index')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('investasi.index')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('harga.coin')}}">
