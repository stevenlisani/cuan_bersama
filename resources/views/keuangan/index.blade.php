                    ...
                    @foreach ($keuangans as $keuangan)
                        <tr>
                            ...
                            @if ( $keuangan->status == 'Prosses')
                                ...
                                <td>
                                    <form action="{{ route('keuangan.destroy', $keuangan->id_keuangan) }}" method="POST">
                                    @csrf
                                    @method('DELETE')

                                        <a data-bs-toggle="modal" data-bs-target="#checkBukti{{$keuangan->id_keuangan}}" class="btn btn-warning btn-md">
                                            <i class="bi bi-pencil-square me-2"></i>Change Status</a>
